 ...
 * bddLayout.js - SysML BDD 커스텀 레이아웃
 *   ELK 결과 위에서 specialization/featuretyping/association 노드 재배치 + 엣지 라우팅.
 *   (elkLayout.js에서 분리: computeCustomBDDLayout + clampChildrenToParent)
 * 규칙: O7~O15, L1~L8, M/H 시리즈 (상세는 .claude/RENDER_RULES.md)
 * ********************************************************************************/
(function () {
  'use strict';
  ...
  NS.computeCustomBDDLayout = computeCustomBDDLayout;
  NS.clampChildrenToParent = clampChildrenToParent;
})();
